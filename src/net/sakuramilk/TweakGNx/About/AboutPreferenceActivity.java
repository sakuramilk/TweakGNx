...
package net.sakuramilk.TweakGNx.About;
...
import net.sakuramilk.TweakGNx.General.SystemPropertySetting;
import net.sakuramilk.TweakGNx.General.VirtualMemorySetting;
import net.sakuramilk.TweakGNx.Parts.ConfirmDialog;
...
public class AboutPreferenceActivity extends PreferenceActivity
    ...
    public boolean onPreferenceClick(Preference preference)
    {
        if (preference == mReset) {
            ...
            Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=net.sakuramilk.TweakGN");
