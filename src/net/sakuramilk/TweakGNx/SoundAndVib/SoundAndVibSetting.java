...
public class SoundAndVibSetting extends SettingManager {
    ...
    private final SysFs mSysFsVibLevel = new SysFs("/sys/devices/virtual/misc/vib_ctrl/vibrator_level");
    private final SysFs mSysFsVibMaxLevel = new SysFs("/sys/devices/virtual/misc/vib_ctrl/vibrator_level_max");
